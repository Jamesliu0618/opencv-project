...
namespace PCBInspection.Tests.Integration
{
    public static class FixtureGenerator
    {
        ...
        public static void CreatePcbWithTwoComponents(string path, int width = 640, int height = 480,
            int c1CenterX = 100, int c1CenterY = 120, int c1W = 40, int c1H = 20,
            int c2CenterX = 220, int c2CenterY = 120, int c2W = 40, int c2H = 20)
        {
