...
namespace PCBInspection.Core.ROI
{
	...
	public class EllipseRoi : RoiBase
	{
		...
		{
			return JsonConvert.SerializeObject(new { CenterX = Center.X, CenterY = Center.Y, RadiusX, RadiusY, Rotation });
		}
		...
		public override void FromGeometryJson(string json)
		{
			...
			var obj = JsonConvert.DeserializeAnonymousType(json, new { CenterX = 0f, CenterY = 0f, RadiusX = 0f, RadiusY = 0f, Rotation = 0f });
