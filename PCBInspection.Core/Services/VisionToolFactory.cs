        ...
        public static List<ToolDefinition> GetAllTools()
        {
            ...
            tools.Add(new ToolDefinition
            {
                ...
                Action = (img, p) =>
                {
                    ...
                    using(var kernel = Cv2.GetStructuringElement(pp.Shape, new Size(pp.KernelSize, pp.KernelSize)))
                    {
                        ...
                        switch(pp.Operation)
                        {
                            case MorphologyParameters.MorphOp.Erode: op = MorphTypes.Erode; break;
                            case MorphologyParameters.MorphOp.Dilate: op = MorphTypes.Dilate; break;
                            case MorphologyParameters.MorphOp.Close: op = MorphTypes.Close; break;
                            case MorphologyParameters.MorphOp.Gradient: op = MorphTypes.Gradient; break;
                            case MorphologyParameters.MorphOp.TopHat: op = MorphTypes.TopHat; break;
                            case MorphologyParameters.MorphOp.BlackHat: op = MorphTypes.BlackHat; break;
                        }
            ...
            tools.Add(new ToolDefinition
            {
                ...
                Action = (img, p) =>
                {
                    ...
                    switch(pp.Type)
                    {
                        case ColorConvertParameters.ConversionType.BGR2HSV: code = ColorConversionCodes.BGR2HSV; break;
                        case ColorConvertParameters.ConversionType.BGR2Lab: code = ColorConversionCodes.BGR2Lab; break;
                        case ColorConvertParameters.ConversionType.HSV2BGR: code = ColorConversionCodes.HSV2BGR; break;
                        case ColorConvertParameters.ConversionType.Gray2BGR: code = ColorConversionCodes.GRAY2BGR; break;
                    }
            ...
            tools.Add(new ToolDefinition
            {
                ...
                Action = (img, p) =>
                {
                    ...
                    if (System.IO.File.Exists(pp.TemplatePath))
                    {
             ...
             tools.Add(new ToolDefinition
            {
                ...
                Action = (img, p) =>
                {
                    ...
                    if (pp.Rotation == RotateFlipParameters.RotationType.Rotate90CW) Cv2.Rotate(result, result, RotateFlags.Rotate90Clockwise);
                    else if (pp.Rotation == RotateFlipParameters.RotationType.Rotate180) Cv2.Rotate(result, result, RotateFlags.Rotate180);
                    else if (pp.Rotation == RotateFlipParameters.RotationType.Rotate90CCW) Cv2.Rotate(result, result, RotateFlags.Rotate90Counterclockwise);

                    if (pp.Flip == RotateFlipParameters.FlipType.Horizontal) Cv2.Flip(result, result, FlipMode.Y);
                    else if (pp.Flip == RotateFlipParameters.FlipType.Vertical) Cv2.Flip(result, result, FlipMode.X);
                    else if (pp.Flip == RotateFlipParameters.FlipType.Both) Cv2.Flip(result, result, FlipMode.XY);
