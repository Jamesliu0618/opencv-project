...
namespace PCBInspection.UI
{
	public class CalibrationWizardForm : Form
	{
		...
		private readonly TextBox txtImagesDir;
		private readonly TextBox txtPatternCols;
		private readonly TextBox txtPatternRows;
		private readonly TextBox txtSquareMm;
		...
		private void BtnBrowse_Click(object sender, EventArgs e)
		{
			using(var dlg = new FolderBrowserDialog())
			{
				...
				{
					txtImagesDir.Text = dlg.SelectedPath;
				}
			}
		}
		...
		private void BtnRun_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					MessageBox.Show("Please select a valid images directory");
					return;
				}
				...
				if(images.Length == 0)
				{
					MessageBox.Show("No PNG images found in directory");
					return;
				}
